...
// Diseño CLÁSICO (original): imagen contain sobre blanco, nombre, swatches de
// color, talles y precio apilados.
export default function ProductCardClasico({ producto, acento, destacado, basePath }: Props) {
